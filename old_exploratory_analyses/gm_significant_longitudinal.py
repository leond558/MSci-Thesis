...
if __name__ == '__main__':
    ...
    regions_of_interest_dictionary = {
        'Planumpolare Right':[114],
        'Occipitalpole Right': [91],
        'Precentralgyrusmedialsegment Right': [85],
        'Middletemporalgyrus Right': [89],
        'Inferiortemporalgyrus Left': [68],
        'Postcentralgyrus Right': [109],
        'Parietaloperculum Right': [107],

    }

    if existing_data:
        # Load pre-processed data from a pickle file
        with open('../pickles/md_gm_significant_longitudinal.pkl', 'rb') as f:
        ...
        with open('../pickles/md_gm_significant_longitudinal.pkl', 'wb') as f:
            pkl.dump(
    ...
    # Add a title
    ax.set_title(
        "Mean Diffusivity in Grey Matter Regions",
    ...
    plt.tight_layout()
    plt.savefig('plots/gm_significant.png')
    ...
    plt.savefig('plots/significant_gm_table.png')
